...
#SBATCH --tasks={{ tasks | 5 }} # increase up to 20 for many function calls
...
This should make the above example run with 5 tasks per job requested. More
...
res = Q(run_mcp, sim=dset, pkgs="mcp", n_jobs=1)
